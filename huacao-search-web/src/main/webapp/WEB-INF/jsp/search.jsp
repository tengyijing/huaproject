...
<title>${query} - 商品搜索 - 花草</title>
<meta name="Keywords" content="java,花草java" />
<meta name="description" content="在huac中找到了29910件类似商品，其中包含了“图书”，“电子书”，“教育音像”，“骑行运动”等类型的java的商品。" />
...
<!-- header end -->
<div class="w main">
	<div class="crumb">全部结果&nbsp;&gt;&nbsp;<strong>"${sum}"</strong></div>
<div class="clr"></div>
<!-- 分页模块 -->
...
<li class="item-book" bookid="11078102">
	...
	<div class="service">由 花草网 发货</div>
	<div class="extra">
